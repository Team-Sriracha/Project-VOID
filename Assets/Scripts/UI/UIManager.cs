...
public class UIManager : MonoBehaviour
{
    ...
    private void UpdatePlayerStats()
    {
        ...
        if (_attackText != null && _cachedWeapon != null) _attackText.text = $"ATK: {_cachedWeapon.CurrentTotalDamage:F0}";
        if (_defenseText != null) _defenseText.text = $"DEF: {(_cachedArmor != null ? _cachedArmor.CurrentDefense : 0f):F0}";
        if (_speedText != null && _cachedController != null) _speedText.text = $"SPD: {_cachedController.GetCurrentMoveSpeed():F0}";
    }
