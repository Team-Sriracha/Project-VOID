...
namespace ProjectVoid.Map
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "MapGenerationSettings", menuName = "ProjectVoid/Map/Generation Settings")]
    public class MapGenerationSettings : ScriptableObject
    {
        ...
        [Header("템플릿")]
        [Tooltip("맵 레이아웃 템플릿 배열 (여러 개 중 랜덤 선택)")]
        [SerializeField] private MapLayoutTemplate[] _mapTemplates;
        ...
        /// 맵 레이아웃 템플릿 배열
        /// </summary>
        public MapLayoutTemplate[] MapTemplates => _mapTemplates;
        ...
        private void OnValidate()
        {
            ...
            if (_mapTemplates == null || _mapTemplates.Length == 0)
            {
                Debug.LogWarning("맵 템플릿이 설정되지 않았습니다!");
            }
        }
