...
public class ItemTierConfig : ScriptableObject
{
    ...
    [SerializeField] private TierSettings[] _tierSettings = new TierSettings[]
    {
        ...
        new TierSettings { Tier = ItemTier.Unique, TierColor = new Color(0.8f, 0.2f, 0.8f), DamageMultiplier = 1.2f, DefenseMultiplier = 1.2f },
        new TierSettings { Tier = ItemTier.Epic, TierColor = new Color(1.0f, 0.5f, 0.0f), DamageMultiplier = 1.3f, DefenseMultiplier = 1.3f },
