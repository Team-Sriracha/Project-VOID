...
public class GameStateManager : NetworkBehaviour
{
    ...
    private void UpdateSessionMatchingInfo(int gameMode, int targetPlayerCount)
    {
        ...
        try
        {
            ...
            {
                bool isCustom = (GameMode)gameMode == GameMode.Custom;
                ...
                var properties = new Dictionary<string, SessionProperty>
                {
                    ...
                    { "IsCustom", isCustom } // 커스텀 모드 여부
                };
                Runner.SessionInfo.UpdateCustomProperties(properties);
                Debug.Log($"[GameStateManager] Session matching info updated - CurrentMatchingMode: {gameMode}, TargetPlayers: {targetPlayerCount}, IsCustom: {isCustom}");
            }
        }
