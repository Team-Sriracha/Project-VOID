...
public class NetworkManager : MonoBehaviour, INetworkRunnerCallbacks
{
    ...
    {
        // Why: 캐시된 InputHandler 검증
        if (_cachedInputHandler != null)
        {
            NetworkObject netObj = _cachedInputHandler.GetComponent<NetworkObject>();
        ...
        // Why: InputAuthority가 있는 플레이어의 InputHandler 찾기
        var allInputHandlers = FindObjectsOfType<PlayerInputHandler>();
