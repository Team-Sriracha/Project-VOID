...
public class NetworkManager : MonoBehaviour, INetworkRunnerCallbacks
{
    ...
    /// <summary>
    /// 생존한 플레이어들의 Dictionary를 읽기 전용으로 반환합니다.
    /// </summary>
    ...
    /// <summary>
    /// 특정 PlayerRef의 NetworkObject를 반환합니다.
    /// </summary>
    /// <param name="player">찾을 PlayerRef</param>
    /// <returns>NetworkObject 또는 null</returns>
    ...
    public void OnPlayerJoined(NetworkRunner runner, PlayerRef player)
    {
        ...
        if (runner.IsServer)
        {
            ...
            Vector3 spawnPosition = new Vector3(UnityEngine.Random.Range(-5f, 5f), 1.5f, UnityEngine.Random.Range(-5f, 5f));
