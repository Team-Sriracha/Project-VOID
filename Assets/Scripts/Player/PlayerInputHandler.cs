...
public class PlayerInputHandler : MonoBehaviour
{
    ...
    public bool IsFirePressed() => IsAttackHeld() && !_previousAttackState;
    public bool IsReloadPressed() => _reloadAction != null && _reloadAction.IsPressed() && !_previousReloadState;
    public bool IsDropWeaponPressed() => _dropWeaponAction != null && _dropWeaponAction.IsPressed() && !_previousDropWeaponState;
    ...
    private bool IsPointerOverBlockingUI()
    {
        ...
        {
            // ItemPickupEntry는 항상 아이템이 있음
            if (result.gameObject.GetComponent<ItemPickupEntry>() != null)
            {
                return true;
            }
            
            // ItemSlotUI는 아이템이 있을 때만 차단
